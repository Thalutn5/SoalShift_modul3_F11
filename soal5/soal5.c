...
struct termios old={0};//ngambil input
...
void *hunger(){//hunger berkurang 5 setiap 5 detik
    while(1){
        sleep(10);
        if(gameState != 1){
...
void *hygiene(){ //hygiene berkurang 10 setiap 30 detik
    while(1){
        sleep(30);
        if(gameState != 1){
...
void *regen(){//healt bertambah 5 jika standby
    while(1){
        sleep(10);
        if(gameState == 0){
...
int main(){
    ...
    if(pthread_create(&tid1, NULL, hunger, NULL)){
        printf("failed\n");
    }

    if(pthread_create(&tid2, NULL, regen, NULL)){
        printf("failed\n");
    }

    if(pthread_create(&tid3, NULL, hygiene, NULL)){
        printf("failed\n");
    }

    if(pthread_create(&tid4, NULL, bath, NULL)){
        printf("failed\n");
    }

    //if(pthread_create(&tid5, NULL,inputFunction, NULL)){
        //printf("failed\n");
    //}
    if(pthread_create(&tid6, NULL, render, NULL)){
        printf("failed\n");
    }
    //if(pthread_create(&tid7, NULL, checkFunction, NULL)){
        //printf("failed\n");
    //}
